...
import jojo.allright.Activity.ConnectionActivity;
 ...
 *
 */
public class RESTConnection extends AsyncTask<String, Void, Void> {

    private JSONObject jsonObject;
    private ConnectionActivity activity;
    private boolean serverError;

    public RESTConnection(ConnectionActivity activity){
